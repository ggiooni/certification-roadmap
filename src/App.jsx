...
const CERTIFICATIONS = [
  ...
  {
    id: 'devops',
    title: 'DevOps Module — Inventory Management System',
    shortTitle: 'DevOps',
    color: '#2ECC71',
    colorFaded: 'rgba(46,204,113,0.15)',
    period: 'Mar – Abr 2026',
    startDate: '2026-03-04',
    endDate: '2026-04-01',
    cost: 'Gratis (módulo universitario)',
    description: 'Proyecto DevOps: Git branching, GitHub Actions CI, Docker, Work Diary.',
    steps: [
      { id: 'dv1', label: 'Semana 1: App funcional + branching strategy + PRs', est: 4, dueDate: '2026-03-11', resources: ['https://github.com/ggiooni/task-manager-simple'] },
      { id: 'dv2', label: 'Semana 2: GitHub Actions CI pipeline', est: 3, dueDate: '2026-03-18', resources: ['https://docs.github.com/en/actions'] },
      { id: 'dv3', label: 'Semana 3: Docker + testing', est: 4, dueDate: '2026-03-25', resources: ['https://docs.docker.com/get-started/'] },
      { id: 'dv4', label: 'Semana 4: Documentación final + Work Diary + entrega', est: 3, dueDate: '2026-04-01', resources: [] },
      { id: 'dv5', label: 'Tarea de Slack (perfil, DM, threads, screenshots)', est: 1, dueDate: '2026-03-18', resources: [] },
      { id: 'dv6', label: 'Completar 10 entradas del Work Diary', est: 5, dueDate: '2026-04-01', resources: [] },
    ],
  },
  {
    id: 'pl500',
